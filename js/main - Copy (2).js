...
async function preload() {
    ...
    await font;length+=10;
    await back;length+=10;
    await playerimg;length+=10;
    await zombie1img;length+=10;
    await zombie2img;length+=10;
    await zombie3img;length+=10;
    await zombie4img;length+=10;
    await zombie5img;length+=10;
    await zombie6img;length+=10;
    await zombie7img;length+=10;
    await zombie8img;length+=10;
    await zombie9img;length+=10;
    await zombie10img;length+=10;
    await zombie11img;length+=10;
    await zombie12img;length+=10;
    await zombie13img;length+=10;
    await zombie14img;length+=10;
    await zombie15img;length+=10;
    await zombie16img;length+=10;
    await zombie17img;length+=10;
    await coinimg;length+=10;
    await reloadimg;length+=10;
    await gameoverimg;length+=10;
    await bulletimg;length+=10;
    await pimg1;length+=10;
    await pimg2;length+=10;
    await pimg3;length+=10;
    await pimg4;length+=10;
    await pimg5;length+=10;
    await pimg6;length+=10;
    await pimg7;length+=10;
}
